	...
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Single Product</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			...
			<form action="ProductController" method="post">
				<div class="row">
					<div class="col-md-6">
						<img src="image/<%=p.getImage() %>" alt="Image" class="img-fluid">
						<input type="file" name="image" >
					</div>
					<div class="col-md-6">
						<h2 class="text-black"><input type="text" name="pname" value="<%=p.getPname()%>"></h2>
							<h2 class="text-black"><input type="text" name="pprice" value="<%=p.getPprice()%>"></h2>
							<input type="submit" name="action" value="update product" class="buy-now btn btn-sm btn-primary">
					</div>
				</div>
				</form>
			</div>
