	...
	<div class="site-wrap">
			...
			<nav class="site-navigation text-right text-md-center"
				...
				<div class="container">
					<ul class="site-menu js-clone-nav d-none d-md-block">
						...
						<li class="has-children"><a href="#">Registration</a>
							<ul class="dropdown">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Seller Registration</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Seller Registration</h2>
					</div>
					<div class="col-md-7">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Contact <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="contact">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Address <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="address">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Password <span
											...
											class="form-control" id="c_lname" name="password">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
