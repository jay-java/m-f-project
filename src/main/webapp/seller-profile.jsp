	...
	<div class="site-wrap">
			...
			<nav class="site-navigation text-right text-md-center"
				...
				<div class="container">
					<ul class="site-menu js-clone-nav d-none d-md-block">
						...
						<li class="has-children"><a href="#"><%=s.getName() %></a>
							<ul class="dropdown">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Seller Profile</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Seller Profile</h2>
					</div>
					<div class="col-md-7">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_fname" class="text-black">Name <span
											...
											class="form-control" id="c_fname" name="name" value="<%=s.getName()%>">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Contact <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="contact" value="<%=s.getContact()%>">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Address <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="address" value="<%=s.getAddress()%>">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">Email <span
											...
											class="form-control" id="c_email" name="email" value="<%=s.getEmail()%>"
											placeholder="">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
										<input type="submit" name="action" class="btn btn-primary btn-lg btn-block"
											value="update">
									</div>
								</div>
							</div>
