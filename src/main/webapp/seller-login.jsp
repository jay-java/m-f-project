				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Seller Login</strong>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<%if(msg!=null){ %>
						<h2 class="h3 mb-3 text-black"><%out.print(msg); %></h2>
						<%} %>
					</div>
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Seller Login</h2>
					</div>
					<div class="col-md-7">
						...
						<form action="SellerController" method="post">
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-lg-12">
										<h4><a href="seller-forgot-password.jsp">Forgot Password ?</a></h4>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
