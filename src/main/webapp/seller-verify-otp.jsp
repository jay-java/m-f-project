	...
	<div class="site-wrap">
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.jsp">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Verify</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Verify</h2>
					</div>
					<div class="col-md-7">
						<form action="SellerController" method="post">
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">OTP <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_email" name="otp2" placeholder="">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
										<input type="submit" name="action"
											class="btn btn-primary btn-lg btn-block" value="verify">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-lg-12">
									<%String otpnot = (String)request.getAttribute("otpnot"); %>
									<%if(otpnot != null){ %>	
										<h4><%out.print(otpnot); %></h4>
									<%} %>
									</div>
								</div>
							</div>
