				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong
							class="text-black">Product List</strong>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="col-md-12" method="post">
						<div class="site-blocks-table">
							<table class="table table-bordered">
								...
								%>
								<%
								List<Product> list = ProductDao.getProductListBySid(id);
								%>
								<%for(Product p: list){ %>
								<tbody>
									<tr>
										<td class="product-thumbnail"><img
											src="image/<%=p.getImage() %>" alt="Image" class="img-fluid" height="100" width="100">
										</td>
										<td class="product-name">
											<h2 class="h5 text-black"><%=p.getPname() %></h2>
										</td>
										<td><%=p.getPprice() %></td>
										<td><a href="seller-single-product.jsp?id=<%=p.getPid()%>" class="btn btn-success btn-sm">Edit</a></td>
