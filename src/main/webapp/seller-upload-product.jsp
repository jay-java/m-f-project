	...
	<header class="site-navbar" role="banner">
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2 class="h3 mb-3 text-black">Upload Product</h2>
					</div>
					<div class="col-md-7">
						...
						<form action="ProductController" method="post" enctype="multipart/form-data">
							...
							<div class="p-3 p-lg-5 border">
								...
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_fname" class="text-black">Image <span
											class="text-danger">*</span></label> <input type="file"
											class="form-control" id="c_fname" name="image">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Name <span
											...
											class="form-control" id="c_lname" name="pname">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_lname" class="text-black">Category <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_lname" name="pcategory">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-12">
										<label for="c_email" class="text-black">Price <span
											class="text-danger">*</span></label> <input type="text"
											class="form-control" id="c_email" name="pprice"
											placeholder="">
									</div>
								</div>
								<div class="form-group row">
